...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{figures/01_activity_frequency.png}\hfill
\includegraphics[width=0.48\textwidth]{figures/02_temporal_distribution.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{figures/03_case_duration_distribution.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{figures/05_top_variants.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{figures/06_dfg_full.png}\hfill
\includegraphics[width=0.48\textwidth]{figures/07_dfg_filtered_heuristic.png}
\caption{DFG completo (esq.) e DFG filtrado --- limiar de 10\% (dir.).}
\label{fig:dfg}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{figures/08_alpha_miner_net.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.56\textwidth]{figures/09_conformance_metrics.png}\hfill
\includegraphics[width=0.40\textwidth]{figures/10_top_deviations.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.56\textwidth]{figures/11_bottlenecks.png}\hfill
\includegraphics[width=0.40\textwidth]{figures/12_wait_by_activity.png}
